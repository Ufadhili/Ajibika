...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.place_map'
        db.add_column(u'core_place', 'place_map',
                      self.gf('django.db.models.fields.files.FileField')(default='file field', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.place_map'
        db.delete_column(u'core_place', 'place_map')
    ...
    models = {
        ...
        u'core.place': {
            ...
            'place_map': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectDocument.page'
        db.delete_column(u'projects_projectdocument', 'page_id')

        # Adding field 'ProjectDocument.project'
        db.add_column(u'projects_projectdocument', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectDocument.page'
        db.add_column(u'projects_projectdocument', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['projects.Project']),
                      keep_default=False)

        # Deleting field 'ProjectDocument.project'
        db.delete_column(u'projects_projectdocument', 'project_id')

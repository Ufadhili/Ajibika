...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'projects_projectvideo')

        # Deleting field 'Project.contractor'
        db.delete_column(u'projects_project', 'contractor')


        # Changing field 'Project.location_name'
        db.alter_column(u'projects_project', 'location_name', self.gf('django.db.models.fields.CharField')(default='current county', max_length=400))

        # Changing field 'Project.estimated_cost'
        db.alter_column(u'projects_project', 'estimated_cost', self.gf('django.db.models.fields.FloatField')(default=10000))

        # Changing field 'Project.summary'
        db.alter_column(u'projects_project', 'summary', self.gf('django.db.models.fields.TextField')(default='project summary'))

        # Changing field 'Project.total_cost'
        db.alter_column(u'projects_project', 'total_cost', self.gf('django.db.models.fields.FloatField')(default=100000))
    ...
    models = {
        ...
        u'projects.projectdocument': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['projects.Project']"})
        },

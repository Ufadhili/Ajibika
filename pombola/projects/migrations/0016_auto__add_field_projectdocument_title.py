...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectDocument.title'
        db.add_column(u'projects_projectdocument', 'title',
                      self.gf('django.db.models.fields.CharField')(default='project document', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectDocument.title'
        db.delete_column(u'projects_projectdocument', 'title')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.activity_to_be_done'
        db.delete_column(u'projects_project', 'activity_to_be_done')

        # Deleting field 'Project.expected_output'
        db.delete_column(u'projects_project', 'expected_output')

        # Deleting field 'Project.location'
        db.delete_column(u'projects_project', 'location')

        # Deleting field 'Project.econ1'
        db.delete_column(u'projects_project', 'econ1')

        # Deleting field 'Project.econ2'
        db.delete_column(u'projects_project', 'econ2')

        # Adding field 'Project.summary'
        db.add_column(u'projects_project', 'summary',
                      self.gf('django.db.models.fields.TextField')(default='summary of the project'),
                      keep_default=False)
        ...
        # Changing field 'Project.sector'
        db.alter_column(u'projects_project', 'sector', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Project.status'
        db.alter_column(u'projects_project', 'status', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'Project.remarks'
        db.alter_column(u'projects_project', 'remarks', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):
        # Adding field 'Project.activity_to_be_done'
        db.add_column(u'projects_project', 'activity_to_be_done',
                      self.gf('django.db.models.fields.CharField')(default='counsult documents', max_length=400),
                      keep_default=False)

        # Adding field 'Project.expected_output'
        db.add_column(u'projects_project', 'expected_output',
                      self.gf('django.db.models.fields.CharField')(default='consult documents', max_length=400),
                      keep_default=False)

        # Adding field 'Project.location'
        db.add_column(u'projects_project', 'location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(default=datetime.datetime(2014, 7, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'Project.econ1'
        db.add_column(u'projects_project', 'econ1',
                      self.gf('django.db.models.fields.CharField')(default='removed', max_length=400),
                      keep_default=False)

        # Adding field 'Project.econ2'
        db.add_column(u'projects_project', 'econ2',
                      self.gf('django.db.models.fields.CharField')(default='removed', max_length=400),
                      keep_default=False)

        # Deleting field 'Project.summary'
        db.delete_column(u'projects_project', 'summary')
        ...
        # Changing field 'Project.sector'
        db.alter_column(u'projects_project', 'sector', self.gf('django.db.models.fields.CharField')(default='sectors', max_length=400))

        # Changing field 'Project.status'
        db.alter_column(u'projects_project', 'status', self.gf('django.db.models.fields.CharField')(default='ongoing', max_length=400))

        # Changing field 'Project.remarks'
        db.alter_column(u'projects_project', 'remarks', self.gf('django.db.models.fields.CharField')(default='check summary', max_length=400))
    ...
    models = {
        ...
        u'documents.document': {
            ...
            'document_type': ('django.db.models.fields.CharField', [], {'default': "'CBL'", 'max_length': '3'}),
        ...
        u'projects.project': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),

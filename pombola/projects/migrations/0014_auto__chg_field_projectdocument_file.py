...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectDocument.file'
        db.alter_column(u'projects_projectdocument', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProjectDocument.file'
        db.alter_column(u'projects_projectdocument', 'file', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

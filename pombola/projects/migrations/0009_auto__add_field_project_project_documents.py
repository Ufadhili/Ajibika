...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.project_documents'
        db.add_column(u'projects_project', 'project_documents',
                      self.gf('django.db.models.fields.files.FileField')(default='project docs', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.project_documents'
        db.delete_column(u'projects_project', 'project_documents')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'project_documents': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),

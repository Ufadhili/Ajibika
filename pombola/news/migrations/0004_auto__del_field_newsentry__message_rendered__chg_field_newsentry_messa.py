...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'NewsEntry._message_rendered'
        db.delete_column(u'news_newsentry', '_message_rendered')


        # Changing field 'NewsEntry.message'
        db.alter_column(u'news_newsentry', 'message', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Adding field 'NewsEntry._message_rendered'
        db.add_column(u'news_newsentry', '_message_rendered',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'NewsEntry.message'
        db.alter_column(u'news_newsentry', 'message', self.gf('markitup.fields.MarkupField')(no_rendered_field=True))

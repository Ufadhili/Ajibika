...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'news_newsentry', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('county', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Place'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=400)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('message', self.gf('markitup.fields.MarkupField')(default='', no_rendered_field=True, blank=True)),
            ('detail_url', self.gf('django.db.models.fields.URLField')(max_length=400, null=True, blank=True)),
            ('publication_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'news', ['NewsEntry'])

        # Adding model 'NewsVideo'
        db.create_table(u'news_newsvideo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'])),
            ('news_entry', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['news.NewsEntry'])),
        ))
        db.send_create_signal(u'news', ['NewsVideo'])


    def backwards(self, orm):
        # Deleting model 'NewsEntry'
        db.delete_table(u'news_newsentry')

        # Deleting model 'NewsVideo'
        db.delete_table(u'news_newsvideo')
    ...
    models = {
        ...
        u'news.newsentry': {
            ...
            'detail_url': ('django.db.models.fields.URLField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('markitup.fields.MarkupField', [], {'default': "''", 'no_rendered_field': 'True', 'blank': 'True'}),
        ...
        u'news.newsvideo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'news_entry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['news.NewsEntry']"}),
